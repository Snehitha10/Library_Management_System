        ...
        if (e.getSource() == addButton) {
            ...
            for (int i = 0; i < books.size(); i++) {
                if (books.get(i)[0].equals(bookID)) {
                    textField1.setText(books.get(i)[0]); // Set the existing book ID
                    textField2.setText(books.get(i)[1]); // Set the existing book title
                    textField3.setText(books.get(i)[2]); // Set the existing author
                    textField4.setText(books.get(i)[3]); // Set the existing publisher
                    textField5.setText(books.get(i)[4]); // Set the existing year of publication
                    textField6.setText(books.get(i)[5]); // Set the existing ISBN
                    textField7.setText(books.get(i)[6]); // Set the existing number of copies
                    JOptionPane.showMessageDialog(this, "Make the necessary edits and click Add to save changes");
                    return;
                }
            }
